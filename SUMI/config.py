...
class Config(object):
    ...
    SUPPORT_CHAT = 'YeahAkenoBotsupport'  #Your own group for support, do not add the @
    JOIN_LOGGER = -1001791449328  #Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -1001791449328  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
